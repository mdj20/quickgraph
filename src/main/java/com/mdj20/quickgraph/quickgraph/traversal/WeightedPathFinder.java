...
extends AbstractPathFinder<BaseWeightedGraph<V,E,W>, V, E> {
	
	protected WeightedPathFinder(BaseWeightedGraph<V,E,W> graph) {
		super(graph);
	}
	
	// factory method infers type parameters, and returns appropriate object
	public static <G extends BaseWeightedGraph<V,E,W>, E extends WeightedEdge<V,W>, V, W extends Number & Comparable<W>> WeightedPathFinder<V,E,W> getWeightedPathFinder(G graph){
	...
	public Path<V,E> bellmanFordIntPath(V source, V sink){
		...
		WeightedPathBuilder<BaseWeightedGraph<V,E,W>,V,E,W> weightedPathBuilder = new WeightedPathBuilder<BaseWeightedGraph<V,E,W>,V,E,W>(graph,source);
